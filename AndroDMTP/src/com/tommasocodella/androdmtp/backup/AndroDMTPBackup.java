package com.tommasocodella.androdmtp.backup;
...
import com.tommasocodella.androdmtp.services.TransportImpl;

public class AndroDMTPBackup implements Runnable, Props.SavePropsCallBack{
    ...
    private static AndroDMTPBackup  DMTP_Main = null;
    ...
    */
    public static AndroDMTPBackup getInstance(AndroDMTPLocationListener locationListener){
        if (DMTP_Main == null) {
            DMTP_Main = new AndroDMTPBackup(locationListener);
        }
        return DMTP_Main;
    }
  ...
  //private long                lastTimeEventTimer = 0L;
    ...
    * implementation.
    */
    public AndroDMTPBackup(AndroDMTPLocationListener locationListener){
        super();
        DMTP_Main = this;
    ...
    */
    public void startApp(){
        if (!this.startupInit) {
            ...
            Log.println(LOG_NAME, "Title  : " + AndroDMTPBackup.getTitle());
